...
const guestCategories = [
  {
    ...
    members: [
      { id: "01", name: "Vital do Rego Filho", role: "Presidente do TCU", country: "Brasil", image: "" },
      { id: "02", name: "Ana Maria Gemo Bié", role: "Presidente do Tribunal Administrativo", country: "Moçambique", image: "" },
      { id: "03", name: "Filipa Urbano Calvão", role: "Presidente do Tribunal de Contas", country: "Portugal", image: "" },
      { id: "04", name: "Ricardino Costa Alegre", role: "Presidente do Tribunal de Contas", country: "S. Tomé e Príncipe", image: "" },
    ]
  },
  {
    title: "Convidados de Honra",
    members: [
      { id: "05", name: "Gareth Davies", role: "Auditor Geral do Reino Unido", country: "Inglaterra", image: "" },
      { id: "06", name: "Wynand Wentzel", role: "Director Executivo da AFROSAI-E", country: "África do Sul", image: "" },
      { id: "07", name: "Pierre Moscovici", role: "Presidente da JURISAI / Cour des comptes", country: "França", image: "" },
      { id: "08", name: "Marco Villas Boas", role: "Dir. Geral da Escola Superior da Magistratura", country: "Brasil", image: "" },
      { id: "09", name: "Marco António da Silva Modes", role: "Procurador-Geral do MPC - Tocantins", country: "Brasil", image: "" },
    ]
  },
  {
  ...
  },
  {
    ...
    members: [
      ...
      { id: "19", name: "Júlio Pinheiro", role: "Conselheiro TCE-AM", country: "Brasil", image: "" },
      ...
      { id: "22", name: "Joaquim Kennedy N. Barros", role: "Presidente TCE-PI", country: "Brasil", image: "" },
    ]
  },
  {
